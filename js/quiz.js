/* ==========================================================================
   Quiz Mapa Mental da Umbanda - 100% Decompiled Exact Engine
   Source: https://quizsarava.lovable.app/
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderState() {
      ...
      contentWrapper.querySelectorAll('.intro-card-item').forEach(card => {
        card.addEventListener('click', (e) => {
          ...
          setTimeout(() => {
            ...
            renderState();
          }, 350); // Touch-to-advance instant delay
        });
      });
      return;
    }
    ...
    if (currentState === 'quiz') {
      ...
      optionBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
          ...
          // Instant Touch-to-Advance Transition (350ms delay for feedback highlight)
          setTimeout(() => {
    ...
    // 8. STATE: frontDuplo (FINAL CHECKOUT OFFER PAGE)
      ...
      contentWrapper.innerHTML = `
        ...
        <div class="fade-in">
          ...
          <div style="background: linear-gradient(180deg, #ffffff 0%, #fffbeb 100%); border: 2px solid #f59e0b; border-radius: 20px; padding: 20px; text-align: center; margin: 20px 0; box-shadow: 0 8px 24px rgba(245, 158, 11, 0.15);">
            ...
            <div style="font-size: 2.4rem; font-weight: 900; color: #2d7555; margin: 4px 0;">R$ 27,00</div>
            <div style="font-size: 0.85rem; font-weight: 700; color: var(--text-dark);">Acesso Vitalício + 10 Bônus Especiais Inclusos</div>
          </div>

          <a href="https://go.perfectpay.com.br/PPU38CQFQCP" target="_blank" class="btn-action btn-buy">
